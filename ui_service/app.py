...
# Function to display standard search results
...
# Function to display marketing results
...
def main():
    # Create a sidebar for app mode selection
    st.sidebar.title("App Mode")
    app_mode = st.sidebar.radio(
        "Choose the app mode:",
        ["Standard Search", "Marketing Content Generator"]
    )
    
    if app_mode == "Standard Search":
        # Display the standard search interface
            ...
            if query:
                with st.spinner("Searching for relevant content..."):
                    ...
                    payload = {
                        ...
                        "use_llava": model_option == "LLaVA (multimodal)"
                    }
    ...
    else:  # Marketing Content Generator Mode
                ...
                with st.spinner("Generating marketing content..."):
                    ...
                    try:
                        response = requests.post(
                            ...
                            json=payload,
                            timeout=200  # Increase timeout for marketing content generation
                        )
